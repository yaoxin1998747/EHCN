...
def train_EHCN(args, X, Hs, mapped_target1 , mapped_target2,nodes,subnodes_info,id_to_index):
	Xs = dict()
	# in_ft= {}
	...
	for key,val in G.items():
		...
		torch.cuda.empty_cache()
	model = EHCN(in_ch=in_ft,n_hid=args.dim,dty_nets=Hs.keys(),inter=args.inter,intra=args.intra,dropout=args.dropout)
