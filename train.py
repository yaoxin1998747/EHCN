...
def parse_args():
	parser = argparse.ArgumentParser(description="Run EHCN")
...
if __name__ == '__main__':
	...
	print("### Start Train!!!")
	embs = train_EHCN(args, init_embs, Hs, mapped_target1 , mapped_target2, nodes,subgraph_info,id_to_index)
